...
debug = True
_code_git_version = "605389db578ccb0acca30e1d8ae1910c43ac0dac"
_code_repository = (
    "https://github.com/plops/cl-py-generator/tree/master/example/128_jax_gemma/source/"
)
_code_generation_time = "15:48:41 of Saturday, 2024-04-20 (GMT+1)"
kagglehub.login()
...
transformer_config = gemma.transformer.TransformerConfig.from_params(
    params=params, cache_size=1024
)
transformer = gemma.transformer.Transformer(transformer_config)
# create sampler
sampler = gemma.sampler.Sampler(
