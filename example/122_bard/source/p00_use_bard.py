...
_code_repository = (
    "https://github.com/plops/cl-py-generator/tree/master/example/122_bard/source/"
)
...
if os.path.exists(config_path):
    ...
    print(
        "{} Read cookies from config file config_path={} cookies={}".format(
            ((time.time()) - (start_time)), config_path, cookies
        )
    )
else:
    ...
    cookies = {
        ("__Secure-1PSID"): ("stub"),
        ("__Secure-1PSIDCC"): ("stub"),
        ("__Secure-1PAPISID"): ("stub"),
    }
