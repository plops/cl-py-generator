...
def get(request: Request):
    ...
    form=Form(Group(Div(transcript, Textarea(placeholder="(Optional) Add Link to original source", name="originalSourceLink"), model, Div(Input(type="checkbox", id="includeComments", name="includeComments"), Label("Include User Comments", _for="includeComments"), style="display: flex; align-items: center; width: 100%;"), Div(Input(type="checkbox", id="includeTimestamps", name="includeTimestamps"), Label("Include Timestamps", _for="includeTimestamps"), style="display: flex; align-items: center; width: 100%;"), Div(Input(type="checkbox", id="includeGlossary", name="includeGlossary"), Label("Include Glossary", _for="includeGlossary"), style="display: flex; align-items: center; width: 100%;"), Button("Summarize Transcript"), style="display: flex; flex-direction:column;")), hx_post="/process_transcript", hx_swap="afterbegin", target_id="gen-list")
