...
plt.grid()
plt.figure()
opr.field.grid_generator(n=6, grid_type="circular", output=True)
plt.grid()
plt.figure()
opr.analysis.spotdiagram(l, [1, 2, 3], [1, 2, 3], n=6, grid_type="circular")
plt.figure()
opr.analysis.Ray_fan(l, [1, 2, 3], [1, 2, 3])
opr.trace.trace_one_ray(l, field_num=2, wave_num=1, ray=[0, -1], start=0, end=0, output=True, output_list=["X", "Y", "Z", "K", "L", "M"])