...
- **Build Date Suffix**: `0324` (aktuell, OpenRC), `0310` (Fallback, Systemd)

> [!NOTE]
> Ab 0320 wird OpenRC anstelle von Systemd genutzt. Das squashfs-Image für das E14 heißt lokal `gentoo.squashfs_e14` und wird als `gentoo.squashfs_0324` abgelegt. Du kannst sehr alte Versionen löschen, um Platz auf der Partition zu machen, aber behalte die Version `0310` als funktionierendes Fallback.
...
menuentry 'Gentoo Dracut (E14 persist OpenRC nvme0n1p4 0324)' {
    insmod part_gpt
    insmod fat
    insmod btrfs
