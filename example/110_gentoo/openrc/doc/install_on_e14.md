...
```bash
cp /home/kiel/stage/cl-py-generator/example/110_gentoo/openrc/config/activate /home/kiel/activate
...
ls -l /run/initramfs/live/0428/packages.txt
grep 'sys-devel/gcc' /run/initramfs/live/0428/packages.txt
```
