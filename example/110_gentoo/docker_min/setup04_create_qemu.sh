...
qemu-img create -f raw qemu/sda1.img 395M
...
parted "$LOOP_DEVICE" mkpart primary fat32 1MiB 385MB # grub, kernel, initramfs, squashfs
parted "$LOOP_DEVICE" mkpart primary ext4 385MB 100% # encrypted persistence
# Set the boot flag
