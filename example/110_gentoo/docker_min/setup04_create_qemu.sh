...
qemu-img create -f raw qemu/sda1.img 367M
...
parted "$LOOP_DEVICE" mkpart primary fat32 1MiB 360MB # grub, kernel, initramfs, squashfs
parted "$LOOP_DEVICE" mkpart primary ext4 360MB 100% # encrypted persistence
# Set the boot flag
