...
parted "$LOOP_DEVICE" mkpart primary fat32 1MiB 400MB # grub, kernel, initramfs, squashfs
parted "$LOOP_DEVICE" mkpart primary ext4 400MB 100% # encrypted persistence
# Set the boot flag
