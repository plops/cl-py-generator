...
info "Mounting SquashFS image from disk"
mount "${SQUASH_SRC_PATH}" /squash || {
    warn "Failed to mount ${SQUASH_SRC_PATH}"
    emergency_shell
}

# --- Setup the OverlayFS ---
info "Mounting overlay filesystem..."
UPPER_DIR="/mnt_persist/persistent/upper" # i think i mixed upper and lower here
