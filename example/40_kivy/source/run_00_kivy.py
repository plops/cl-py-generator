...
_code_git_version="a91dfb0e20ff81f767b0f8a2c16fa9379feb706e"
_code_repository="https://github.com/plops/cl-py-generator/tree/master/example/29_ondrejs_challenge/source/run_00_start.py"
_code_generation_time="12:51:01 of Saturday, 2021-04-03 (GMT+1)"
...
class PongGame(Widget):
    ...
    def serve_ball(self):
        ...
        self.ball.v=Vector(4, 0).rotate(random.randint(0, 360))
    def update(self, dt):
        self.ball.move()
