# deps_de.md — Dependency-Pfade (org/projekt) für DeepWiki-Abfragen

Deutsche Übersetzung von `plan/20260924_01_cluster_search/deps.md`.

Format: `https://deepwiki.com/<org>/<projekt>`. Jeweils neueste Version nehmen
(siehe plan.md §3).
