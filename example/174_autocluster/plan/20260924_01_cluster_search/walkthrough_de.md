# walkthrough_de.md — Cluster-Suche: was wirklich implementiert wurde

Deutsche Übersetzung von `walkthrough.md` (Stand 2026-09-24).
...
- Output: `plots/best_clusters.png` (1500×1200, validiert), `plots/labels.csv`
  (12.569 identifier→cluster), `results_*.csv` (120 bewertete Configs), `ablation.md`.
- 3072-D-Benefit quantifiziert: +5,2 % ggü. 768, +13,5 % ggü. 128 (adj. Score).
...
HDBSCAN), `validate.py` (Scoring im Originalraum, 40-%-Noise-Veto), `run_pilot.py`,
